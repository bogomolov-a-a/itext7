...
/**
 * Class with common logic for lookup subtypes of GPOS Lookup type 6
 * @deprecated To be removed in 7.2. Use {@link ChainingContextualTable} with {@link ContextualSubstRule}
 * parametrization instead.
 */
@Deprecated
public abstract class SubTableLookup6 extends ChainingContextualTable<ContextualSubstRule> {
